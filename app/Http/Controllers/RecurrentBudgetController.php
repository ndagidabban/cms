...
class RecurrentBudgetController extends Controller
{
        ...
        {
            $recurrents = Recurrent::all();
    
            return view('nmd.recurrents', compact('recurrents'));
        }
        ...
        public function register(Request $request)
        {
            ...
            Recurrent::create($request->all());
    
            return redirect('recurrentbudget');
        }
        ...
        public function search(Request $request)
{
    ...
    $model = new Recurrent();
    $recurrents = $this->searchHelper($request, $model, $columns);
    return view('nmd.recurrents', compact('recurrents'));
}
...
private function searchByRange($range, $model) {
    ...
    return $model;   
        ...
        /*  public function search(Request $request)
        {
            ...
            $recurrents = Recurrent::where('zone', $request->get('zone'))->where('state', 
            $request->get('state'))->where('speciality', 
            $request->get('speciality'))->where('code', $request->get('code'))->get();
    
            //return view('nmd.recurrent', compact('recurrents'));
            return view('nmd.recurrents');
        }
    }
   ...
   // {
     //   $recurrents = Recurrent::where('zone', $request->get('zone'))->where('state', 
      ...
      //  $request->get('speciality'))->where('range', $request->get('range'))->get();
       ...
       // return view('nmd.capitalbudget', compact('recurrents'));
    //}
