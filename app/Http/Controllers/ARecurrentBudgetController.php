...
class ARecurrentBudgetController extends Controller
{
        ...
        {
            $arecurrents = ARecurrent::all();
    
            return view('nmd.arecurrents', compact('arecurrents'));
        }
        ...
        public function register(Request $request)
        {
            ...
            ARecurrent::create($request->all());
    
            return redirect('arecurrentbudget');
        }
        ...
        public function search(Request $request)
{
    ...
    $model = new ARecurrent();
    $arecurrents = $this->searchHelper($request, $model, $columns);
    return view('nmd.arecurrents', compact('arecurrents'));
}
